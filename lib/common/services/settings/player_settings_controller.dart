...
class PlayerSettingsController extends GetxController {
  ...
  final RxString videoPlayerKey = hiveString('videoPlayerKey', 'mediaKit');
  ...
  static const List<BoxFit> videoFitArray = [
    BoxFit.contain,
    BoxFit.cover,
    BoxFit.fill,
    BoxFit.fitHeight,
  ...
  void fromJson(Map<String, dynamic> json) {
    ...
    videoPlayerKey.v = json['videoPlayerKey'] ?? 'mediaKit';
  ...
  static Map<String, dynamic> extractConfig(Map<String, dynamic>? rootConfig) {
    ...
    return {
      ...
      'videoPlayerKey': player['videoPlayerKey'] ?? 'mediaKit',
