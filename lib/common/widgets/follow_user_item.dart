...
class _FollowUserItemState extends State<FollowUserItem>
  ...
  Widget build(BuildContext context) {
    ...
    final site = Sites.of(item.platform!);
    final bool isLive = item.liveStatus == LiveStatus.live;
            ...
            children: [
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: NetImage(item.avatar  ?? "", width: 48, height: 48),
                ),
              ),
              AppStyle.hGap12,
              Expanded(
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        AppStyle.hGap8,
                        if (widget.playing || item.liveStatus != LiveStatus.offline)
                          Container(
                            padding: const EdgeInsets.symmetric(
                              horizontal: 8,
                              vertical: 2,
