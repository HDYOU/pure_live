...
/// Flame UI 版本的热门页
/// 新 UI 放在这里，旧的 popular_page.dart 保持不变
class PopularFlamePage extends GetView<PopularController> {
  const PopularFlamePage({super.key});
...
class _PopularFlameGridViewState extends State<_PopularFlameGridView> {
  late PopularGridController _gridController;
