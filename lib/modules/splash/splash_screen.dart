...
enum LoaderType { spinner, dots, progressBar, lottie }
  ...
  Widget _buildLoader() {
    switch (widget.loaderType) {
      ...
      case LoaderType.progressBar:
        return SizedBox(
          width: 200,
          child: LinearProgressIndicator(backgroundColor: Colors.white.withOpacity(0.3), color: Colors.white),
        );
      case LoaderType.lottie:
        if (widget.lottieAsset != null && widget.lottieAsset!.isNotEmpty) {
          return Lottie.asset(
            widget.lottieAsset!,
