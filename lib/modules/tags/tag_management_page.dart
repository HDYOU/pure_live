        ...
        children: [
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                _buildGroupTitle(context, i18n('tag_management')),
                Obx(() {
                    ...
                    return Center(
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Icon(Remix.price_tag_3_line, size: 48, color: theme.disabledColor.withOpacity(0.4)),
                    ...
                    return Material(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: theme.colorScheme.secondary.withOpacity(0.3), width: 1.0),
                        ),
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  // 分割线
                                  Container(width: 1, height: 14, color: theme.dividerColor.withOpacity(0.1)),
                                  // 2. 编辑按钮
                                  Expanded(
                                    child: InkWell(
                                      borderRadius: BorderRadius.circular(6),
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text(
              i18n('tag_desc_label'),
              style: AppTextStyles.t12.copyWith(color: theme.colorScheme.onSurfaceVariant.withOpacity(0.6)),
            ),
            const SizedBox(height: 6),
            TextField(
