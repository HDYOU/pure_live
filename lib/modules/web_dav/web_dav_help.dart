...
class WebDavHelpPage extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildStepCard(context, stepContent: const ["1. 网页右上角头像 → 点击【账户信息】"]),
          const SizedBox(height: 16),
          _buildStepCard(context, stepContent: const ["2. 左侧菜单栏打开【安全选项】"]),
          const SizedBox(height: 16),
          _buildStepCard(
            context,
          ...
          const SizedBox(height: 16),
          _buildStepCard(context, stepContent: const ["5. 生成16位随机密码，立刻复制保存，密码仅展示一次，丢失需重开"]),
          const SizedBox(height: 24),

          // 五、通用绑定
          _buildSectionTitle(context, "五、任意软件WebDAV通用绑定教程"),
        ...
        children: [
          ListTile(
            ...
            trailing: IconButton(
              ...
              onPressed: () {
                Clipboard.setData(const ClipboardData(text: davUrl));
  ...
  // 步骤卡片：文字居左
  Widget _buildStepCard(BuildContext context, {required List<String> stepContent}) {
    final theme = Theme.of(context);
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: _cardDecoration(theme),
  ...
  BoxDecoration _cardDecoration(ThemeData theme) {
    return BoxDecoration(
      ...
      border: Border.all(color: theme.dividerColor.withOpacity(0.08), width: 0.5),
    );
  }
}
