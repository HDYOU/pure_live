      ...
      actions: [
        PopupMenuButton<int>(
          ...
          itemBuilder: (BuildContext context) => [
            PopupMenuItem(
              value: 1,
              child: _MenuListTile(leading: const Icon(Icons.refresh), text: i18n("webdav_refresh")),
            ),
            PopupMenuItem(
              value: 2,
              child: _MenuListTile(leading: const Icon(Icons.menu), text: i18n("webdav_open_config_list")),
            ),
            PopupMenuItem(
              value: 3,
              child: _MenuListTile(leading: const Icon(Remix.question_line), text: i18n("webdav_help_tutorial")),
            ),
          ],
        ),
      ],
...
class _MenuListTile extends StatelessWidget {
  ...
  final String text;
  const _MenuListTile({required this.leading, required this.text});
