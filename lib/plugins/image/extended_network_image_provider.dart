...
///
/// copy from extended_image_library\lib\src\network\network_image_io.dart
class ExtendedNetworkImageProvider extends ImageProvider<image_provider.ExtendedNetworkImageProvider>
  ...
  Future<Uint8List?> loadNetwork(
    ...
    try {
      ...
      final HttpClientResponse? response = await tryGetResponse(resolved);
  ...
  Future<HttpClientResponse> getResponse(Uri resolved) async {
  ...
  Future<HttpClientResponse?> tryGetResponse(
    Uri resolved,
  ) async {
